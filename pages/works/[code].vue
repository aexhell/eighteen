<template>
   <div id="__EIGHTEEN-WORK" class="flex flex-col overflow-hidden w-full justify-center relative">
      <ContentRenderer :value="data">
         <template #default>
            <div style="height: calc(100vh - 235px)" class="w-full h-screen relative flex flex-col">
               <div class="m-auto flex flex-col items-center">
                  <h2 class="separator xl:text-[10rem] lg:text-9xl md:text-8xl text-6xl m-auto text-center text-black dark:text-white font-bold w-fit" v-text="data.titlePage" />
            ...
            <div id="__EIGHTEEN-BLOG-CONTAINER" class="text-black backdrop-blur-[12px] flex flex-col gap-2 mt-36 pb-12 w-full">
               ...
               <nuxt-link to="/" class="flex text-black dark:text-white pl-8 my-6">
         ...
         <template #not-found>
            <h2 class="xl:text-7xl my-4 lg:text-6xl text-black dark:text-white text-5xl font-bold w-fit">
               This page doesn't exist.
            </h2>
            <div id="__EIGHTEEN-BLOG-CONTAINER" class="text-black dark:text-white flex flex-col gap-2 pb-12 w-full">
               <nuxt-link to="/" class="flex text-black dark:text-white mt-6">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
                  </svg>
                  Return to index page.
