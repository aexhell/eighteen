<template>
   <div id="__EIGHTEEN-BLOG" class="flex flex-col overflow-hidden md:w-1/2 w-full md:px-auto px-12 justify-start">
      <ContentDoc>
            ...
            <div class="flex items-center mt-2 w-full mb-8 relative">
               ...
               <div class="flex w-full justify-between">
                  ...
                  <div class="z-10 text-sm ml-4 flex items-center">
                     ...
                     <span><b>{{ doc.read_time }}</b> {{ doc.read_type }} read</span>
                  </div>
               </div>
            </div>
            <div id="__EIGHTEEN-BLOG-CONTAINER" class="text-white flex flex-col gap-2 pb-12 w-full">
               <ContentRenderer :value="doc" />
               <hr class="w-full">
               <nuxt-link to="/blog" class="flex mt-6">
         ...
         <template #not-found>
            <h2 class="xl:text-7xl my-4 lg:text-6xl text-white text-5xl font-bold w-fit">
