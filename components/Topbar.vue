   ...
   <header class="w-full relative z-20" id="__EIGHTEEN-TOPBAR">
      <nav class="md:py-12 md:px-24 px-8 md:border-none border-b border-b-solid border-black/10 dark:border-white/10 py-8 flex items-center dark:text-white text-black justify-between">
         ...
         <ul class="list-none flex justify-end items-center gap-4 p-0 m-0">
            ...
            <div class="rounded-lg hidden md:block bg-white/20 text-black dark:text-white dark:bg-white/10 md:px-4 px-2 py-1 border border-solid dark:border-white/20 backdrop-blur-[2px] relative z-10 uppercase text-xs border-black/20 text-white">
               {{ date }}
            </div>
         </ul>
      </nav>
