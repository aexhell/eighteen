<template>
   <div class="__EIGHTEEN-PROJECT z-20 py-24 md:mx-24 mx-8 rounded-lg relative shadow-xl bg-black/50 dark:bg-black/50 hover:backdrop-blur-sm hover:bg-black/40 dark:hover:bg-white/5 transition-all">
