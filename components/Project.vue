<template>
   <component :is="componentToDisplay" :to="`/works/${data.code}`" :class="{ 'relative': column, 'absolute': !column, 'grayscale': !active }" class="__EIGHTEEN-PROJECT z-50 lg:py-42 py-24 w-full h-auto transition-all">
      ...
      <div class="__EIGHTEEN-PROJECT-TITLE opacity-0 absolute transition-all top-5 left-4 text-black dark:text-white">
