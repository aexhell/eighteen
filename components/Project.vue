<template>
   <component :is="componentToDisplay" :to="`${data.link}`" :class="{ 'no-landing-project': !data.landing, 'relative': column, 'absolute': !column }" class="__EIGHTEEN-PROJECT z-50 lg:py-42 py-24 w-full h-auto transition-all">
