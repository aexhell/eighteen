<template>
   <div :class="{ 'relative': column, 'absolute': !column }" class="__EIGHTEEN-PROJECT z-50 lg:py-32 py-24 w-full h-auto rounded-lg bg-black/50 dark:bg-black/50 md:backdrop-blur-[2px] hover:bg-black/40 dark:hover:bg-white/5 transition-all">
      ...
      <div class="__EIGHTEEN-PROJECT-DETAILS absolute z-[-1] opacity-0 my-auto xl:bottom-10 lg:bottom-8 md:bottom-4 bottom-9 right-0 text-white">
         <div class="md:text-sm text-xs text-right">
            <div class="flex items-center justify-end">
               ...
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ml-2 md:w-6 md:h-6 w-5 h-5">
