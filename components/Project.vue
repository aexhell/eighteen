<template>
   <component :is="componentToDisplay" :to="`${data.link}`" :class="{ 'relative': column, 'absolute': !column }" class="__EIGHTEEN-PROJECT z-50 lg:py-42 py-24 w-full h-auto transition-all">
