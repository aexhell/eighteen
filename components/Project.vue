<template>
   <div :class="{ 'relative mx-8': column, 'absolute': !column }" class="__EIGHTEEN-PROJECT z-50 lg:py-32 py-24 w-full h-auto rounded-lg bg-black/50 dark:bg-black/50 md:backdrop-blur-[2px] hover:bg-black/40 dark:hover:bg-white/5 transition-all">
